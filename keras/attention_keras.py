...
class Attention_pure_directional(Layer):
    ...
    def __init__(self, nb_head, size_per_head,T_inputs, **kwargs):
        ...
        self.output_dim = nb_head*size_per_head
        self.T_input = T_inputs
        super(Attention_pure_directional, self).__init__(**kwargs)
    ...
    def build(self, input_shape):
        ...
        self.WV = self.add_weight(name='WV',
                                  ...
                                  initializer='glorot_uniform',
                                  trainable=True)
        super(Attention_pure_directional, self).build(input_shape)
...
class Attention_addnorm(Layer):
    ...
    def call(self, x):
        ...
        #Add
        O_seq+=Q_origin
        print('O_seq+=Q_origin shape:',O_seq.shape,Q_origin.shape)

        # Normalize
        O_seq = normalize(O_seq)  # (N, T_q, C)
        return O_seq
...
class Attention_addnorm_direction(Layer):
