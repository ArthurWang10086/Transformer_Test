...
if __name__ == '__main__':
    YUZHI=3+1
    time_norm = 10
    file = open('dataset/event_mimic_train.txt','r')
    final_data=[]
    final_label=[]
    count=0
    ...
    file = open('dataset/time_mimic_train.txt','r')
    final_time=[]
    final_time_gap = []
    final_time_label=[]
    final_time_raw=[]
    ...
    file = open('dataset/event_mimic_test.txt','r')
    final_data=[]
    final_label=[]
    count=0
    for line in file.readlines():
    ...
    file = open('dataset/time_mimic_test.txt','r')
    final_time=[]
    final_time_gap=[]
    final_time_label=[]
    final_time_raw=[]
