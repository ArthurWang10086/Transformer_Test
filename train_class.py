...
class Transformer_Graph():
    ...
    def transformer(self,enc_embed_input,action_length,target,issin = False,is_training=True):
        ...
        with tf.variable_scope("softmax"):
            ...
            flatten = tf.contrib.layers.flatten(enc)
    ...
    def model_train(self):
        ...
        with self.graph.as_default():
            ...
            with tf.name_scope("optimization"):
                ...
                logits = self.transformer(input_data_logdesignid_enc,hp.output_unit,batch_target)
                # Predicr label
                ...
                with tf.Session(graph=self.graph) as sess:
                    ...
                    for batch_i, (pad_enc_logdesignid_batch, train_targets_batch) in enumerate(self.generator_batches(datatype='train')):
                        ...
                        if batch_i % hp.display_step == 0:
                            ...
                            summary, validation_loss, validation_precision, validation_recall, validation_f1, validation_acc = sess.run(
                                [merged, cost, precision, recall, f1, acc],
                            ...
                            print('Epoch {:>3}/{} Batch {:>4}/{} - Loss: {:>6.3f}  - Validation loss: {:>6.3f}  - Validation acc: {:>6.3f} - Precision: {:>6.3f} - Recall: {:>6.3f} - f1: {:>6.3f}'
                                  .format(epoch_i,
                                          hp.epochs,
